...
- Renamed `AZ_ERROR_DEPENDENCY_NOT_PROVIDED` to `AZ_ERROR_HTTP_ADAPTER_DEPENDENCY_NOT_PROVIDED`.
- Add new `az_result` value `AZ_ERROR_PLATFORM_DEPENDENCY_NOT_PROVIDED` which is returned by the no-op platform layer implementation.
