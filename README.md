...
Follow next steps to install VCPKG and have it linked to cmake. The vcpkg repository is checked out at the ref in [vcpkg-ref.txt](eng/vcpkg-ref.txt). Azure SDK code in this version is known to work at that vcpkg ref.
