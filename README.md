...
> Note: Setting up a development environment in windows without VCPKG is not recommended. It requires installing all dev-dependencies globally and manually setting cmake files to link each of them.
