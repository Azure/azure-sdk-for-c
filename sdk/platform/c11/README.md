# Azure Platform abstraction layer implemented with C11 standard library

Azure C11 Platform abstraction layer (`az_c11`) provides platform-specific implementation for the small set of features that Azure SDK needs, yet they are not available as a part of the C99 standard library. This library follows the Azure SDK Design Guidelines for Embedded C.
