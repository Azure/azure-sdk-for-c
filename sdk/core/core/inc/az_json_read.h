...
enum {
  // success codes
  AZ_JSON_NO_MORE_ITEMS         = AZ_MAKE_RESULT(AZ_JSON_RESULT, 1),

  // error codes
  AZ_JSON_ERROR_UNEXPECTED_END  = AZ_MAKE_ERROR(AZ_JSON_RESULT, 1),
  AZ_JSON_ERROR_UNEXPECTED_CHAR = AZ_MAKE_ERROR(AZ_JSON_RESULT, 2),
  AZ_JSON_ERROR_INVALID_STATE   = AZ_MAKE_ERROR(AZ_JSON_RESULT, 3),
  AZ_JSON_ERROR_STACK_OVERFLOW  = AZ_MAKE_ERROR(AZ_JSON_RESULT, 4),
};
