...
typedef enum az_result
{
  ...
  AZ_CANCELED = _az_RESULT_MAKE_ERROR(AZ_FACILITY_CORE, 0),

  // Core
  AZ_ERROR_ARG = _az_RESULT_MAKE_ERROR(AZ_FACILITY_CORE, 1),
  AZ_ERROR_ARITHMETIC_OVERFLOW = _az_RESULT_MAKE_ERROR(AZ_FACILITY_CORE, 2),
  AZ_ERROR_BUFFER_OVERFLOW = _az_RESULT_MAKE_ERROR(AZ_FACILITY_CORE, 3),
  AZ_ERROR_OUT_OF_MEMORY = _az_RESULT_MAKE_ERROR(AZ_FACILITY_CORE, 4),
  AZ_ERROR_NOT_IMPLEMENTED = _az_RESULT_MAKE_ERROR(AZ_FACILITY_CORE, 5),
  AZ_ERROR_ITEM_NOT_FOUND = _az_RESULT_MAKE_ERROR(AZ_FACILITY_CORE, 6),
  AZ_ERROR_PARSER_UNEXPECTED_CHAR = _az_RESULT_MAKE_ERROR(AZ_FACILITY_CORE, 7),
