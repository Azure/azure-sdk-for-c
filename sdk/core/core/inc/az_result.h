...
typedef enum az_result {
  ...
  // XML error codes
  AZ_ERROR_XML_INVALID_STATE = AZ_MAKE_ERROR(AZ_XML_FACILITY, 1),
  AZ_ERROR_XML_STACK_OVERFLOW = AZ_MAKE_ERROR(AZ_XML_FACILITY, 2),
  AZ_ERROR_XML_STRING_END = AZ_MAKE_ERROR(AZ_XML_FACILITY, 3),
  AZ_ERROR_XML_POINTER_TOKEN_END = AZ_MAKE_ERROR(AZ_XML_FACILITY, 4),
  AZ_ERROR_XML_NO_HEADER_FOUND = AZ_MAKE_ERROR(AZ_XML_FACILITY, 5),
  AZ_ERROR_XML_TAG_NOT_MATCH = AZ_MAKE_ERROR(AZ_XML_FACILITY, 6),
