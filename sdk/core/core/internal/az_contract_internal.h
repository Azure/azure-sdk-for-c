...
#define AZ_CONTRACT_ARG_VALID_NON_EMPTY_SPAN(span) \
    AZ_CONTRACT(az_span_ptr(span) != NULL && az_span_capacity(span) > 0 && az_span_length(span) > 0 && az_span_length(span) <= az_span_capacity(span), AZ_ERROR_ARG)
