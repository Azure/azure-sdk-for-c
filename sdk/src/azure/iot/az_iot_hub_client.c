...
static const az_span client_sdk_version_default_value = AZ_SPAN_LITERAL_FROM_STR("azsdk-c%2F" AZ_SDK_VERSION_STRING) ;
    ...
    size_t* out_mqtt_user_name_length)
{
  ...
  {
    required_length += az_span_size(hub_client_param_separator_span) + az_span_size(client_sdk_device_client_type_name)
