...
enum az_log_classification_iot
{
  ...
  = _az_LOG_MAKE_CLASSIFICATION(_az_FACILITY_CORE_MQTT, 1), ///< Accepted MQTT topic received.

  AZ_LOG_MQTT_RECEIVED_PAYLOAD
  = _az_LOG_MAKE_CLASSIFICATION(_az_FACILITY_CORE_MQTT, 2), ///< Accepted MQTT payload received.
