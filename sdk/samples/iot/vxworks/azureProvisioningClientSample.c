...
use "azure sdk for embedded c" to provision a device to Azure IoT Hub.
 ...
 */
static az_span const provisioningIdScope = AZ_SPAN_LITERAL_FROM_STR("0ne0038B9D7");
 ...
 */
static char provisioningGlobalEndpoint[] = "ssl://global.azure-devices-provisioning.net:8883";
 ...
 *
 * This routine publishes a messsage to Azure IoT Hub Provisioning Service.
 *
 * ERRNO: N/A
 *
...
/*******************************************************************************
 *
 * queryStatusSend - publish a query status message to a Provisioning Service
 *
 * This routine publishes a query status message to a Provisioning Service to
 * check whether a provisioning operation is completed or not.
 *
 * ERRNO: N/A
 *
 * RETURNS: N/A
...
)
{
  if (az_iot_provisioning_client_operation_complete(response->operation_status))
  {
    ...
    {
      printf_s("Device provisioning is failed!\n");
    }
...
/*******************************************************************************
 *
 * azureProvisioningClientCreate - create an Azure IoTHub provisioning client obj
 *
 * This routine creates and initializes an Azure IoT Hub Provisioning
 ...
 * the Azure IoT Hub Provisioning Service to provision a new device to the
 * Azure IoT Hub.
 *
 * ERRNO: N/A
 *
