...
9. Monitor the telemetry messages sent to the Azure IoT Hub using the `iothubowner` connection string found under "Shared access policies" on the IoT Hub portal.
