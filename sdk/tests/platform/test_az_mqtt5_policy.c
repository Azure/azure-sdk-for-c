...
#define TEST_MQTT_ENDPOINT_TLS "ssl://localhost"
#else
#define TEST_MQTT_ENDPOINT_TLS "localhost"
#endif
...
#define TEST_CERTIFICATE_PATH ""
#define TEST_CLIENT_CERTIFICATE_PATH ""
#define TEST_CLIENT_KEY_PATH ""
...
static void test_az_mqtt5_policy_tls_enabled_outbound_connect_success(void** state)
{
  ...
  test_options_tls.certificate_authority_trusted_roots = AZ_SPAN_FROM_STR(TEST_CERTIFICATE_PATH);
  ...
  az_mqtt5_connect_data test_mqtt5_connect_data_tls = {
    ...
    .password = AZ_SPAN_LITERAL_FROM_STR(TEST_MQTT_PASSWORD),
    .client_id = AZ_SPAN_LITERAL_FROM_STR(TEST_MQTT_CLIENT_ID),
    .certificate = { AZ_SPAN_LITERAL_FROM_STR(TEST_CLIENT_CERTIFICATE_PATH),
                     .key = AZ_SPAN_LITERAL_FROM_STR(TEST_CLIENT_KEY_PATH) },
    .properties = NULL,
  };
