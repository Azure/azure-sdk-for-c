...
static void test_az_iot_pnp_client_commands_response_get_publish_topic_NULL_client_fail()
{
...
static void test_az_iot_pnp_client_commands_response_get_publish_topic_NULL_out_topic_fail()
{
  char test_buf[TEST_SPAN_BUFFER_SIZE];
  size_t test_length;
...
static void test_az_iot_pnp_client_commands_response_get_publish_topic_zero_size_buffer_fail()
{
  char test_buf[TEST_SPAN_BUFFER_SIZE];
  size_t test_length;
...
static void test_az_iot_pnp_client_commands_response_get_publish_topic_EMPTY_request_id_fail()
{
  char test_buf[TEST_SPAN_BUFFER_SIZE];
  size_t test_length;
...
static void
test_az_iot_pnp_client_commands_response_get_publish_topic_AZ_SPAN_NULL_request_id_fail()
{
  char test_buf[TEST_SPAN_BUFFER_SIZE];
  size_t test_length;
...
static void test_az_iot_pnp_client_commands_parse_received_topic_NULL_client_fail()
{
  ...
  ASSERT_PRECONDITION_CHECKED(
      az_iot_pnp_client_commands_parse_received_topic(NULL, received_topic, &out_request));
}

static void test_az_iot_pnp_client_commands_parse_received_topic_EMPTY_received_topic_fail()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void test_az_iot_pnp_client_commands_parse_received_topic_AZ_SPAN_NULL_received_topic_fail()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void test_az_iot_pnp_client_commands_parse_received_topic_NULL_out_request_fail()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
  ...
  ASSERT_PRECONDITION_CHECKED(
      az_iot_pnp_client_commands_parse_received_topic(&client, received_topic, NULL));
}

#endif // AZ_NO_PRECONDITION_CHECKING

static void test_az_iot_pnp_client_commands_response_get_publish_topic_succeed()
{
  char test_buf[TEST_SPAN_BUFFER_SIZE];
  size_t test_length;
...
static void test_az_iot_pnp_client_commands_response_get_publish_topic_user_status_succeed()
{
  char test_buf[TEST_SPAN_BUFFER_SIZE];
  size_t test_length;
...
static void test_az_iot_pnp_client_commands_response_get_publish_topic_user_status_small_buf_fail()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void
test_az_iot_pnp_client_commands_response_get_publish_topic_INSUFFICIENT_BUFFER_for_prefix_fail()
{
  char test_buf[10];
  size_t test_length;
...
static void
test_az_iot_pnp_client_commands_response_get_publish_topic_INSUFFICIENT_BUFFER_for_status_fail()
{
...
static void test_az_iot_pnp_client_commands_parse_received_topic_succeed()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void test_az_iot_pnp_client_commands_parse_received_topic_c2d_topic_fail()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void test_az_iot_pnp_client_commands_parse_received_topic_topic_filter_fail()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void test_az_iot_pnp_client_commands_parse_received_topic_response_topic_fail()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void test_az_iot_pnp_client_commands_logging_succeed()
{
  ...
  az_iot_pnp_client_command_request out_request;
  assert_true(
      az_iot_pnp_client_commands_parse_received_topic(&client, _log_expected_topic, &out_request)
      == AZ_OK);
...
int test_az_iot_pnp_client_commands()
{
#ifndef AZ_NO_PRECONDITION_CHECKING
...
#ifndef AZ_NO_PRECONDITION_CHECKING
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_response_get_publish_topic_NULL_out_topic_fail),
    cmocka_unit_test(test_az_iot_pnp_client_commands_response_get_publish_topic_NULL_client_fail),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_response_get_publish_topic_zero_size_buffer_fail),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_response_get_publish_topic_EMPTY_request_id_fail),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_response_get_publish_topic_AZ_SPAN_NULL_request_id_fail),
    cmocka_unit_test(test_az_iot_pnp_client_commands_parse_received_topic_NULL_client_fail),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_parse_received_topic_EMPTY_received_topic_fail),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_parse_received_topic_AZ_SPAN_NULL_received_topic_fail),
    cmocka_unit_test(test_az_iot_pnp_client_commands_parse_received_topic_NULL_out_request_fail),
#endif // AZ_NO_PRECONDITION_CHECKING
    cmocka_unit_test(test_az_iot_pnp_client_commands_response_get_publish_topic_succeed),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_response_get_publish_topic_user_status_succeed),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_response_get_publish_topic_user_status_small_buf_fail),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_response_get_publish_topic_INSUFFICIENT_BUFFER_for_prefix_fail),
    cmocka_unit_test(
        test_az_iot_pnp_client_commands_response_get_publish_topic_INSUFFICIENT_BUFFER_for_status_fail),
