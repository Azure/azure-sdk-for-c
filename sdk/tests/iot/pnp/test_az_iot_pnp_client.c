...
static void test_az_iot_pnp_client_get_user_name_NULL_client_fails(void** state)
{
  ...
  ASSERT_PRECONDITION_CHECKED(
      az_iot_pnp_client_get_user_name(NULL, test_buf, sizeof(test_buf), &test_length));
}

static void test_az_iot_pnp_client_get_user_name_NULL_input_span_fails(void** state)
{
  (void)state;
  ...
  ASSERT_PRECONDITION_CHECKED(
      az_iot_pnp_client_get_user_name(&client, NULL, sizeof(test_buf), &test_length));
}

static void test_az_iot_pnp_client_get_user_name_NULL_output_span_fails(void** state)
{
  (void)state;
  ...
  ASSERT_PRECONDITION_CHECKED(az_iot_pnp_client_get_user_name(&client, test_buf, 0, &test_length));
}

static void test_az_iot_pnp_client_get_client_id_NULL_client_fails(void** state)
{
  (void)state;
  ...
  ASSERT_PRECONDITION_CHECKED(
      az_iot_pnp_client_get_client_id(NULL, test_buf, sizeof(test_buf), &test_length));
}

static void test_az_iot_pnp_client_get_client_id_NULL_input_span_fails(void** state)
{
  (void)state;
  ...
  ASSERT_PRECONDITION_CHECKED(
      az_iot_pnp_client_get_client_id(&client, NULL, sizeof(test_buf), &test_length));
}

static void test_az_iot_pnp_client_get_client_id_NULL_output_span_fails(void** state)
{
  (void)state;
  ...
  ASSERT_PRECONDITION_CHECKED(az_iot_pnp_client_get_client_id(&client, test_buf, 0, &test_length));
}
...
static void test_az_iot_pnp_client_init_succeed(void** state)
{
  ...
  assert_memory_equal(
      TEST_DEVICE_ID_STR,
      az_span_ptr(client._internal.iot_hub_client._internal.device_id),
      _az_COUNTOF(TEST_DEVICE_ID_STR) - 1);
  assert_memory_equal(
      TEST_HUB_HOSTNAME_STR,
      az_span_ptr(client._internal.iot_hub_client._internal.iot_hub_hostname),
...
static void test_az_iot_pnp_client_get_user_name_with_model_id_succeed(void** state)
{
  (void)state;
...
static void test_az_iot_pnp_client_get_user_name_with_model_id_small_buffer_fail(void** state)
{
  (void)state;
...
static void test_az_iot_pnp_client_get_user_name_with_model_id_user_options_succeed(void** state)
{
  (void)state;
...
static void test_az_iot_pnp_client_get_user_name_with_model_id_user_options_small_buffer_fail(
    void** state)
{
  (void)state;
...
static void test_az_iot_pnp_client_get_client_id_succeed(void** state)
{
  (void)state;
...
static void test_az_iot_pnp_client_get_client_id_small_buffer_fail(void** state)
{
  (void)state;
...
static void test_az_iot_pnp_client_get_client_id_module_succeed(void** state)
{
  (void)state;
...
static void test_az_iot_pnp_client_get_client_id_module_small_buffer_fail(void** state)
{
  (void)state;
...
int test_az_iot_pnp_client()
{
  ...
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test(test_az_iot_pnp_client_init_NULL_device_id_fails),
    cmocka_unit_test(test_az_iot_pnp_client_init_NULL_model_id_fails),
    cmocka_unit_test(test_az_iot_pnp_client_init_NULL_hub_hostname_id_fails),
    cmocka_unit_test(test_az_iot_pnp_client_get_user_name_NULL_client_fails),
    cmocka_unit_test(test_az_iot_pnp_client_get_user_name_NULL_input_span_fails),
    cmocka_unit_test(test_az_iot_pnp_client_get_user_name_NULL_output_span_fails),
    cmocka_unit_test(test_az_iot_pnp_client_get_client_id_NULL_client_fails),
    cmocka_unit_test(test_az_iot_pnp_client_get_client_id_NULL_input_span_fails),
    cmocka_unit_test(test_az_iot_pnp_client_get_client_id_NULL_output_span_fails),
#endif // AZ_NO_PRECONDITION_CHECKING
    ...
    cmocka_unit_test(test_az_iot_pnp_client_get_user_name_with_model_id_succeed),
    cmocka_unit_test(test_az_iot_pnp_client_get_user_name_with_model_id_small_buffer_fail),
    cmocka_unit_test(test_az_iot_pnp_client_get_user_name_with_model_id_user_options_succeed),
    cmocka_unit_test(
        test_az_iot_pnp_client_get_user_name_with_model_id_user_options_small_buffer_fail),
    cmocka_unit_test(test_az_iot_pnp_client_get_client_id_succeed),
    cmocka_unit_test(test_az_iot_pnp_client_get_client_id_small_buffer_fail),
    cmocka_unit_test(test_az_iot_pnp_client_get_client_id_module_succeed),
    cmocka_unit_test(test_az_iot_pnp_client_get_client_id_module_small_buffer_fail),
  };
