...
static void az_iot_pnp_client_sas_get_signature_NULL_signature_fails()
{
  ...
  ASSERT_PRECONDITION_CHECKED(
      az_iot_pnp_client_sas_get_signature(&client, test_sas_expiry_time_secs, signature, NULL));
}

static void az_iot_pnp_client_sas_get_signature_NULL_signature_span_fails()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
  ...
  ASSERT_PRECONDITION_CHECKED(az_iot_pnp_client_sas_get_signature(
      &client, test_sas_expiry_time_secs, signature, &signature));
}

static void az_iot_pnp_client_sas_get_signature_NULL_client_fails()
{
  ...
  ASSERT_PRECONDITION_CHECKED(
      az_iot_pnp_client_sas_get_signature(NULL, test_sas_expiry_time_secs, signature, &signature));
}

static void az_iot_pnp_client_sas_get_password_EMPTY_signature_fails()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
  ...
  ASSERT_PRECONDITION_CHECKED(az_iot_pnp_client_sas_get_password(
      &client,
...
static void az_iot_pnp_client_sas_get_password_NULL_password_span_fails()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void az_iot_pnp_client_sas_get_password_empty_password_buffer_span_fails()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void az_iot_pnp_client_sas_get_signature_device_succeeds()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
  ...
  assert_true(az_result_succeeded(az_iot_pnp_client_sas_get_signature(
...
static void az_iot_pnp_client_sas_get_signature_module_succeeds()
{
  az_iot_pnp_client client;
...
static void az_iot_pnp_client_sas_get_password_device_succeeds()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
  ...
  assert_true(az_result_succeeded(az_iot_pnp_client_sas_get_password(
      &client,
      test_sas_expiry_time_secs,
      test_signature,
      key_name,
...
static void az_iot_pnp_client_sas_get_password_device_no_out_length_succeeds()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void az_iot_pnp_client_sas_get_password_module_succeeds()
{
  az_iot_pnp_client client;
  az_iot_pnp_client_options options;
  options.module_id = test_module_id;
...
static void az_iot_pnp_client_sas_get_password_module_no_length_succeeds()
{
  az_iot_pnp_client client;
  az_iot_pnp_client_options options;
  options.module_id = test_module_id;
...
static void az_iot_pnp_client_sas_get_password_device_with_keyname_succeeds()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void az_iot_pnp_client_sas_get_password_module_with_keyname_succeeds()
{
  az_iot_pnp_client client;
  az_iot_pnp_client_options options;
  options.module_id = test_module_id;
...
static void az_iot_pnp_client_sas_get_password_device_overflow_fails()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void az_iot_pnp_client_sas_get_password_module_overflow_fails()
{
  az_iot_pnp_client client;
  az_iot_pnp_client_options options;
  options.module_id = test_module_id;
...
static void az_iot_pnp_client_sas_get_signature_device_signature_overflow_fails()
{
  az_iot_pnp_client client;
  assert_true(
      az_iot_pnp_client_init(&client, test_device_hostname, test_device_id, test_model_id, NULL)
...
static void az_iot_pnp_client_sas_get_signature_module_signature_overflow_fails()
{
  az_iot_pnp_client client;
  az_iot_pnp_client_options options;
  options.module_id = test_module_id;
...
int test_az_iot_pnp_client_sas()
{
#ifndef AZ_NO_PRECONDITION_CHECKING
...
#ifndef AZ_NO_PRECONDITION_CHECKING
    cmocka_unit_test(az_iot_pnp_client_sas_get_signature_NULL_signature_fails),
    cmocka_unit_test(az_iot_pnp_client_sas_get_signature_NULL_signature_span_fails),
    cmocka_unit_test(az_iot_pnp_client_sas_get_signature_NULL_client_fails),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_EMPTY_signature_fails),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_NULL_password_span_fails),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_empty_password_buffer_span_fails),
#endif // AZ_NO_PRECONDITION_CHECKING
    cmocka_unit_test(az_iot_pnp_client_sas_get_signature_device_succeeds),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_device_no_out_length_succeeds),
    cmocka_unit_test(az_iot_pnp_client_sas_get_signature_module_succeeds),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_module_no_length_succeeds),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_device_succeeds),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_module_succeeds),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_device_with_keyname_succeeds),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_module_with_keyname_succeeds),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_device_overflow_fails),
    cmocka_unit_test(az_iot_pnp_client_sas_get_password_module_overflow_fails),
    cmocka_unit_test(az_iot_pnp_client_sas_get_signature_device_signature_overflow_fails),
    cmocka_unit_test(az_iot_pnp_client_sas_get_signature_module_signature_overflow_fails),
    cmocka_unit_test(test_az_iot_pnp_client_sas_logging_succeed),
    cmocka_unit_test(test_az_iot_pnp_client_sas_no_logging_succeed),
  };
  return cmocka_run_group_tests_name("az_iot_pnp_client_sas", tests, NULL, NULL);
}
