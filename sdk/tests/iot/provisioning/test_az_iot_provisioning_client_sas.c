...
static void test_az_iot_provisioning_client_sas_logging_succeed(void** state)
{
  (void)state;
...
static void test_az_iot_provisioning_client_sas_no_logging_succeed(void** state)
{
  (void)state;
