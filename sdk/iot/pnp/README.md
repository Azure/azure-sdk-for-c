...
WARNING: the Azure IoT Plug and Play client is still under development and not ready for customer use. Any attempt to use this Azure IoT Plug and Play client will not be supported until its public availability announcement.  
