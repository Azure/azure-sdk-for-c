# Azure IoT Clients for Embedded C: Azure IoT Common Library

This is a support library only for internal use by the Azure IoT Embedded C SDK.

The use of any of the Azure IoT Common library functions and/or definitions outside Azure IoT Embedded C SDK is not supported.
