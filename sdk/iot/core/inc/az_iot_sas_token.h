 ...
 * @param document[in]            An #az_span to use as base for `out_document`.
 * @param out_document[out]       A pointer to #az_span where to write the SAS token document to be encrypted.
 ...
 * @param sas_token[in]           An #az_span to use as base for `out_sas_token`.
 * @param out_sas_token[out]      An pointer to #az_span where to write the SAS token.
 * @returns                       An #az_result with the result of the operation.
 * @retval                        #AZ_OK                       If no failures occur. 
