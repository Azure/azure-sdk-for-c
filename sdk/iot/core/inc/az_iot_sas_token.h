 ...
 * 
 * @brief API's to generate and use SAS tokens
 */
 ...
 *   @retval                      #AZ_ERROR_BUFFER_OVERFLOW    If the buffer provided in #az_iot_sas_params or `document` are insufficient in size.
 ...
 * @return                        An #az_result with the result of the operation.
 *   @retval                      #AZ_OK                       If no failures occur. 
 *   @retval                      #AZ_ERROR_BUFFER_OVERFLOW    If the buffer provided in #az_iot_sas_params or `sas_token` are insufficient in size.
 *   @retval                      #AZ_ERROR_ARG                If `params` is NULL or any of its components are NULL or a NULL #az_span, or
