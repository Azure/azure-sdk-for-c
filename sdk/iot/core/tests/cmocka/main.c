...
void az_iot_hub_client_telemetry_publish_topic_get_with_options_with_params_small_buffer_fails(void** state);
void az_iot_hub_client_telemetry_publish_topic_get_no_options_with_params_succeed(void** state);
void az_iot_hub_client_telemetry_publish_topic_get_no_options_with_params_small_buffer_fails(void** state);
void az_iot_hub_client_telemetry_publish_topic_get_with_options_module_id_with_params_succeed(void** state);
void az_iot_hub_client_telemetry_publish_topic_get_with_options_module_id_with_params_small_buffer_fails(void** state);
void az_iot_hub_client_telemetry_publish_topic_get_with_options_user_agent_with_params_succeed(void** state);
void az_iot_hub_client_telemetry_publish_topic_get_with_options_user_agent_with_params_small_buffer_fails(void** state);
...
int main()
{
  const struct CMUnitTest tests[] = {
    ...
    // Telemetry
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_NULL_client_fails),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_NULL_mqtt_topic_fails),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_NULL_out_mqtt_topic_fails),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_no_options_no_params_succeed),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_with_options_no_params_succeed),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_with_options_with_params_succeed),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_with_options_with_params_small_buffer_fails),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_no_options_with_params_succeed),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_no_options_with_params_small_buffer_fails),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_with_options_module_id_with_params_succeed),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_with_options_module_id_with_params_small_buffer_fails),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_with_options_user_agent_with_params_succeed),
    cmocka_unit_test(az_iot_hub_client_telemetry_publish_topic_get_with_options_user_agent_with_params_small_buffer_fails),
  };
