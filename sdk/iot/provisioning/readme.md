...
- Pelase refer to the state machine diagram which describes the Azure SDK for Embedded C flow for DPS [here](https://github.com/Azure/azure-sdk-for-c/blob/master/sdk/iot/doc/mqtt_state_machine.md#device-provisioning-service). 
